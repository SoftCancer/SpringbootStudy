...
@MapperScan(basePackages = "com.dongl.boot_config_13_redis.dao.slave",
...
//    final static String SLAVE_PREFIX = "spring.datasource.druid.slave";
    // mapper.xml 文件存放路径
    public static final String MAPPER_XML_LOCATION = "classpath*:com/dongl/boot_config_13_redis/dao/slave/mapper/*.xml";

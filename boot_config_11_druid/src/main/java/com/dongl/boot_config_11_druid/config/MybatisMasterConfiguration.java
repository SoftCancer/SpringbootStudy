...
@MapperScan(basePackages = "com.dongl.boot_config_11_druid.dao.master",
...
public class MybatisMasterConfiguration {
    ...
    // mapper.xml 文件存放路径
    public static final String MAPPER_XML_LOCATION = "classpath*:com/dongl/boot_config_11_druid/dao/master/mapper/*.xml";
